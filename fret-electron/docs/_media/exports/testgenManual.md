...
- 'Kind 2': The [Kind 2](https://kind2-mc.github.io/kind2/)  model checker and the [Z3](https://github.com/Z3Prover/z3)  theorem prover must be installed. Latest known supported version for Kind 2 is v2.2.0 (**Version v2.3.0 is NOT supported.**), and v4.14.1 for Z3.
