...
pathFormula :
  	 ...
  	 | pathFormula lite pathFormula colon pathFormula #pathITE
         ...
         | unaryBoundedPathOp timeBound lpr stateFormula rpr
	   #pathBoundedUnary
         | lpr stateFormula binaryBoundedPathOp timeBound
           stateFormula rpr #pathBoundedBinary
         | lpr pathFormula binaryPathOp
           pathFormula rpr  #pathBinary
	   ;
...
arithExpr : 
    ...
    probOp : 'P' ;
    time : arithExpr ;     // TIME : NATNUM ('.' [0-9]+)? ;
    probNum : NUMBER ; //PROBABILITYNUMBER ;

    ID: [_a-zA-Z][_a-zA-Z0-9]* ;

    //PROBABILITYNUMBER: '0' | '1' | '0.' [0-9]+ ;
    NUMBER : NATNUM ('.' [0-9]+)? ;
