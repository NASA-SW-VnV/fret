...
await selReq.click();
var req1 = await app.client.$('#qa_ltlSim_mi_Req_1_');
await req1.click();
var req2 = await app.client.$('#qa_ltlSim_mi_Req_2_');
await req2.click();
var selTrace = await app.client.$('#qa_ltlSim_sel_Trace');
await selTrace.click();
var traceNew = await app.client.$('#qa_ltlSim_mi_traceNew');
await traceNew.click();
var traceProject = await app.client.$('#qa_ltlSim_mi_traceLoadProject');
await traceProject.click();
var traceReq = await app.client.$('#qa_ltlSim_mi_traceLoadRequirement');
await traceReq.click();
var traceSave = await app.client.$('#qa_ltlSim_mi_traceSaveJSON');
await traceSave.click();
var traceName = await app.client.$('#qa_ltlSim_mi_trace_name_');
await traceName.click();
var addDetails = await app.client.$('#qa_ltlSim_ib_addDetails');
await addDetails.click();
var addDetailsDialog = await app.client.$('#qa_ltlSimAdd_Dialog');
var elementHTML = await addDetailsDialog.getHTML(false);
var elementParsedHTML = parse(elementHTML);
var elementText = elementParsedHTML.text;  
console.log('pastComponent text: ', elementText);  
var addDetailID = await app.client.$('#qa_ltlSimAdd_tf_traceID');
await addDetailID.click();
var addDetailDescription = await app.client.$('#qa_ltlSimAdd_tf_description');
await addDetailDescription.click();
var cancel = await app.client.$('#qa_ltlSimAdd_btn_cancel');
await cancel.click();
