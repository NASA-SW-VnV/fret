...
Probability_auxContext.prototype.WHAT = function() {
    return this.getToken(RequirementParser.WHAT, 0);
};
...
RequirementParser.prototype.probability_aux = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
        case RequirementParser.WHAT:
            this.enterOuterAlt(localctx, 1);
            this.state = 211;
            this.match(RequirementParser.WHAT);
            this.state = 212;
            this.match(RequirementParser.PROB);
            break;
        case RequirementParser.PROB:
            this.enterOuterAlt(localctx, 2);
            this.state = 213;
            this.match(RequirementParser.PROB);
            this.state = 214;
