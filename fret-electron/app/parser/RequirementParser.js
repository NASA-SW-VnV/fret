...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "FALSE", "FINALLY", "FIRST", "FOR", "HOUR", "IF", 
                      "IMMEDIATELY", "IN", "INITIALLY", "IS", "LAST", "MICROSECOND", 
                      "MILLISECOND", "MINUTE", "MOD", "MODE", "NEVER", "NEXT", 
                      "NOT", "OCCURRENCE", "OF", "ONLY", "OR", "PREVIOUS", 
                      "SAME", "SATISFY", "SECOND", "SHALL", "THE", "THEN", 
                      "TICK", "TIMEPOINT", "TRUE", "UNLESS", "UNTIL", "UPON", 
                      "WHEN", "WHENEVER", "WHERE", "WHILE", "WITHIN", "XOR", 
                      "ID", "STRING", "RELATIONAL_OP", "NUMBER", "DIGITS", 
                      "REQT_ID", "WS" ];
...
RequirementParser.FIRST = 32;
RequirementParser.FOR = 33;
RequirementParser.HOUR = 34;
RequirementParser.IF = 35;
RequirementParser.IMMEDIATELY = 36;
RequirementParser.IN = 37;
RequirementParser.INITIALLY = 38;
RequirementParser.IS = 39;
RequirementParser.LAST = 40;
RequirementParser.MICROSECOND = 41;
RequirementParser.MILLISECOND = 42;
RequirementParser.MINUTE = 43;
RequirementParser.MOD = 44;
RequirementParser.MODE = 45;
RequirementParser.NEVER = 46;
RequirementParser.NEXT = 47;
RequirementParser.NOT = 48;
RequirementParser.OCCURRENCE = 49;
RequirementParser.OF = 50;
RequirementParser.ONLY = 51;
RequirementParser.OR = 52;
RequirementParser.PREVIOUS = 53;
...
RequirementParser.WITHIN = 70;
RequirementParser.XOR = 71;
RequirementParser.ID = 72;
RequirementParser.STRING = 73;
RequirementParser.RELATIONAL_OP = 74;
RequirementParser.NUMBER = 75;
RequirementParser.DIGITS = 76;
RequirementParser.REQT_ID = 77;
...
RequirementParser.prototype.reqt = function() {
    ...
    try {
        ...
        this.state = 64;
        _la = this._input.LA(1);
        if(!(((((_la - 72)) & ~0x1f) == 0 && ((1 << (_la - 72)) & ((1 << (RequirementParser.ID - 72)) | (1 << (RequirementParser.DIGITS - 72)) | (1 << (RequirementParser.REQT_ID - 72)))) !== 0))) {
...
RequirementParser.prototype.nasa = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << RequirementParser.T__3) | (1 << RequirementParser.AFTER) | (1 << RequirementParser.ALWAYS) | (1 << RequirementParser.AT) | (1 << RequirementParser.BEFORE) | (1 << RequirementParser.EVENTUALLY) | (1 << RequirementParser.FINALLY))) !== 0) || ((((_la - 33)) & ~0x1f) == 0 && ((1 << (_la - 33)) & ((1 << (RequirementParser.FOR - 33)) | (1 << (RequirementParser.IMMEDIATELY - 33)) | (1 << (RequirementParser.INITIALLY - 33)) | (1 << (RequirementParser.NEVER - 33)) | (1 << (RequirementParser.UNTIL - 33)))) !== 0) || _la===RequirementParser.WITHIN) {
            this.state = 90;
            this.timing();
        }
...
RequirementParser.prototype.qualifier_word = function() {
    ...
    try {
        ...
        this.state = 167;
        _la = this._input.LA(1);
        if(!(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (RequirementParser.IF - 35)) | (1 << (RequirementParser.UNLESS - 35)) | (1 << (RequirementParser.UPON - 35)) | (1 << (RequirementParser.WHEN - 35)))) !== 0) || _la===RequirementParser.WHENEVER || _la===RequirementParser.WHERE)) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
RequirementParser.prototype.timing_aux = function() {
    ...
    try {
        ...
        case RequirementParser.AT:
            ...
            this.state = 227;
            _la = this._input.LA(1);
            if(!(((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (RequirementParser.FIRST - 32)) | (1 << (RequirementParser.LAST - 32)) | (1 << (RequirementParser.NEXT - 32)) | (1 << (RequirementParser.SAME - 32)))) !== 0))) {
            this._errHandler.recoverInline(this);
            }
            else {
            	this._errHandler.reportMatch(this);
...
RequirementParser.prototype.timeunit = function() {
    ...
    try {
        ...
        this.state = 247;
        _la = this._input.LA(1);
        if(!(((((_la - 34)) & ~0x1f) == 0 && ((1 << (_la - 34)) & ((1 << (RequirementParser.HOUR - 34)) | (1 << (RequirementParser.MICROSECOND - 34)) | (1 << (RequirementParser.MILLISECOND - 34)) | (1 << (RequirementParser.MINUTE - 34)) | (1 << (RequirementParser.SECOND - 34)) | (1 << (RequirementParser.TICK - 34)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
